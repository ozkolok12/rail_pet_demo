...
class RailDataETL(LoggingMixin):
    ...
    def __init__(self):
        ...
        self.staging_cols = [
            ...
            "shipment_category", "cargo_class", "estimated_arrival_date",
            "arrival_date", "release_date", "transport_type", "cargo_name",
            "departure_country", "sender", "destination_country", "receiver",
            "wagon_type_group", "wagon_type", "wagon_owner", "operator",
            "wagon_km", "volume", "tariff",
            "load_dttm", "source_file_name"
        ]
